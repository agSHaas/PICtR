...
#' @param ratio The meta.data column with the classification of cells into ratio_high and ratio_low using the FSC.A/FSC.H ratio and Otsu's thresholding method.
#' @param ratio_high The character string that indicates cells with a FSC.A/FSC.H ratio above the threshold determined with Otsu's method within the meta.data column.
